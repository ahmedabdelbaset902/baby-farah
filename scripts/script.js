...
function addToCalendar() {
    ...
    const title = "حفل زفاف عبدالرحمن & حبيبه";
    const details = "نتشرف بحضوركم حفل زفافنا";
    const location = " قاعه ديفا العبد  طنطا طريق كفر الزيات   ";
    ...
    if (!isIOS) {
        ...
        const start = "20260620T200000";
const end   = "20260621T010000";
...
SUMMARY:${title}
DTSTART;TZID=Africa/Cairo:20260620T200000
DTEND;TZID=Africa/Cairo:20260621T010000
LOCATION:${location}
DESCRIPTION:${details}
END:VEVENT
END:VCALENDAR`;
